      ...
      <div className="container mx-auto px-6 md:px-12 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-6">
          {lawyerData.courts.map((court, index) => (
            ...
            >
              <div className="w-10 h-10 rounded-full bg-indigo-500/10 flex items-center justify-center text-indigo-600 group-hover:bg-indigo-600 group-hover:text-white transition-all">
                <FaGavel />
              </div>
